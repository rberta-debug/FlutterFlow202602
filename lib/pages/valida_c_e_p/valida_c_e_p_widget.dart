...
import 'valida_c_e_p_model.dart';
export 'valida_c_e_p_model.dart';

class ValidaCEPWidget extends StatefulWidget {
  const ValidaCEPWidget({super.key});

  static String routeName = 'validaCEP';
  static String routePath = '/validaCEP';

  @override
  State<ValidaCEPWidget> createState() => _ValidaCEPWidgetState();
}

class _ValidaCEPWidgetState extends State<ValidaCEPWidget> {
  late ValidaCEPModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ValidaCEPModel());
    ...
    _model.textFieldLocalidadeTextController ??= TextEditingController();
    _model.textFieldLocalidadeFocusNode ??= FocusNode();
              ...
              Column(
                ...
                children: [
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (_) => EasyDebounce.debounce(
                        ...
                        () async {
                          ...
                          _model.apiResultwd2 = await BuscarCEPCall.call(
                          ...
                          safeSetState(() {
                            _model.textFieldRuaTextController?.text =
                                BuscarCEPCall.rua(
                              (_model.apiResultwd2?.jsonBody ?? ''),
                            )!;
                          });
                          safeSetState(() {
                            _model.textFieldLocalidadeTextController?.text =
                  ...
                  Container(
                    width: 200.0,
                    child: TextFormField(
                      controller: _model.textFieldLocalidadeTextController,
                      focusNode: _model.textFieldLocalidadeFocusNode,
                      autofocus: false,
                      enabled: true,
                      obscureText: false,
                      decoration: InputDecoration(
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed(ValidaCPFWidget.routeName);
                      },
                      text: 'CPF',
